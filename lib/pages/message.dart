                                        ...
                                        ? Card(
                                            ...
                                            child: ListTile(
                                              ...
                                              trailing: snapshot
                                                          ...
                                                          .length !=
                                                      0
                                                  ? snapshot.data.documents[index].data["seenLastMessage"] == false
                                                      ? sendName != snapshot.data.documents[index].data["chat"].last["auteur"]
                                                          ? DotComponent(
                                                              number: snapshot.data.documents[index].data["chat"].length -
